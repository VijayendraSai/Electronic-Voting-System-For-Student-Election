...
public class Vote_F 
{
	...
	public void vote(int index)
	{
		if(index==0 && !voted[0])
		{
			...
			cls = Integer.parseInt(c); 
			r = Integer.parseInt(n);
			while(cls!=6 || (r<1 || r>68) || r==nominee1)
			{
				if(r==nominee1)
				{
		...
		else if(voted[0])
		{
			if(!voted[index])
			{
				...
				if(nominee1<10)
					System.out.println("1.CB.EN.U4CSE1760"+nominee1);
				else
					System.out.println("1.CB.EN.U4CSE176"+nominee1);
				if(nominee2<10)
					System.out.println("2.CB.EN.U4CSE1760"+nominee2);
				else
					System.out.println("2.CB.EN.U4CSE176"+nominee2);
	...
	public String Winner()
	{
		...
		{
			if(nominee1<10)
				return "CB.EN.U4CSE1760"+nominee1;
			else
				return "CB.EN.U4CSE176"+nominee1;
			
		}
		else if(votes2>votes1)
		{
			if(nominee2<10)
				return "CB.EN.U4CSE1760"+nominee2;
			else
				return "CB.EN.U4CSE176"+nominee2;
		}
		else
			return "VOTES DRAWED";
	}
